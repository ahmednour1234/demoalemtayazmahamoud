...
class ProjectsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::statement('INSERT INTO `projects` (`id`, `name`, `code`, `description`, `status_id`, `owner_id`, `lead_id`, `priority`, `start_date`, `due_date`, `active`, `deleted_at`, `created_at`, `updated_at`) VALUES
