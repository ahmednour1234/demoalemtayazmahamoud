...
class CreateResultVisitorsTable extends Migration
{
    ...
    public function up()
    {
        ...
        DB::statement("CREATE TABLE `result_visitors` ( `id` bigint(20) UNSIGNED NOT NULL, `admin_id` bigint(20) UNSIGNED NOT NULL, `customer_id` bigint(20) UNSIGNED NOT NULL, `note` mediumtext NOT NULL, `lat` mediumtext NOT NULL, `lang` mediumtext NOT NULL, `created_at` timestamp NOT NULL DEFAULT current_timestamp(), `updated_at` timestamp NOT NULL DEFAULT current_timestamp(), `deleted_at` timestamp NULL DEFAULT NULL ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;");
        DB::statement("ALTER TABLE `result_visitors` ADD PRIMARY KEY (`id`);");
        DB::statement("ALTER TABLE `result_visitors` MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;");
