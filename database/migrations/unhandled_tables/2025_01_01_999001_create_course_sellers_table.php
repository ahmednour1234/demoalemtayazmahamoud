...
class CreateCourseSellersTable extends Migration
{
    ...
    public function up()
    {
        ...
        DB::statement("-- -------------------------------------------------------- -- -- Table structure for table `course_sellers` -- CREATE TABLE `course_sellers` ( `id` int(20) UNSIGNED NOT NULL, `admin_id` bigint(20) UNSIGNED NOT NULL, `seller_id` bigint(20) UNSIGNED NOT NULL, `name` varchar(500) NOT NULL DEFAULT 'غير معروف', `link` mediumtext DEFAULT NULL, `img` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`img`)), `created_at` timestamp NOT NULL DEFAULT current_timestamp(), `updated_at` timestamp NOT NULL DEFAULT current_timestamp(), `deleted_at` timestamp NULL DEFAULT NULL ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;");
        DB::statement("-- -- Indexes for table `course_sellers` -- ALTER TABLE `course_sellers` ADD PRIMARY KEY (`id`);");
        DB::statement("-- -- AUTO_INCREMENT for table `course_sellers` -- ALTER TABLE `course_sellers` MODIFY `id` int(20) UNSIGNED NOT NULL AUTO_INCREMENT;");
