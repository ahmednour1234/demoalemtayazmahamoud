...
class CreateHistoryInstallmentsTable extends Migration
{
    ...
    public function up()
    {
        ...
        DB::statement("-- -------------------------------------------------------- -- -- Table structure for table `history_installments` -- CREATE TABLE `history_installments` ( `id` bigint(20) UNSIGNED NOT NULL, `seller_id` bigint(20) UNSIGNED DEFAULT NULL, `customer_id` bigint(20) UNSIGNED NOT NULL, `supplier_id` bigint(20) DEFAULT NULL, `branch_id` bigint(20) NOT NULL DEFAULT 1, `total_price` int(11) NOT NULL DEFAULT 0, `note` mediumtext NOT NULL, `contract_id` bigint(20) DEFAULT NULL, `scheduled_installment_id` bigint(20) DEFAULT NULL, `notification` int(11) NOT NULL DEFAULT 1, `created_at` timestamp NULL DEFAULT NULL, `updated_at` timestamp NULL DEFAULT NULL, `img` mediumtext DEFAULT NULL, `deleted_at` timestamp NULL DEFAULT NULL ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;");
        DB::statement("-- -- Indexes for table `history_installments` -- ALTER TABLE `history_installments` ADD PRIMARY KEY (`id`), ADD KEY `seller_id` (`seller_id`), ADD KEY `customer_id` (`customer_id`);");
        DB::statement("-- -- AUTO_INCREMENT for table `history_installments` -- ALTER TABLE `history_installments` MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;");
